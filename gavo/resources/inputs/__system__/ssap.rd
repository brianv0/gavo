...
<resource resdir="__system" schema="dc">
	...
	<condDesc id="humanPosQuery">
		<!-- a condDesc generating input keys for a human-oriented cone
		search on SSAP tables, as you would use them in form-based
		interfaces.  -->
		<inputKey name="hscs_pos" type="text"
			description= "Coordinates (as h m s, d m s or decimal degrees), 
				or SIMBAD-resolvable object" tablehead="Position/Name">
		</inputKey>
