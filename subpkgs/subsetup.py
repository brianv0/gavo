...
# To re-enable the use of namespace packages, add this to baseKeys:
#	"namespace_packages": ["gavo"],
# and 
# "gavo/__init__.py" to baseFiles.
...
subpkgs = {
	...
	"stc": {
		...
		"install_requries": ["gavoutils"],
		"dependency_links": ["http://vo.ari.uni-heidelberg.de/soft"],
		"MAINTREEFILES": [
